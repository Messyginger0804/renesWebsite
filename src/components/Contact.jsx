...
function Contact() {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_0fdj2mx', 'template_s2t184g', form.current, '_0eJeVE_0upDw61qU')
            .then(toast.success(`thank you for you message!!!`))
        e.target.reset();
    ...
    return (
        ...
        <div className='flex flex-wrap justify-center gap-8 my-[10%]'>
            ...
            <div className='pb-20 flex flex-col gap-3 justify-center items-center md:visible'>
                ...
                <a className='flex align-center text-center gap-2 items-center text-xl hover:underline text-slate-100' href='tel:2147794259'><FaPhoneVolume className='text-2xl hover:underline text-slate-100' />214-779-4259</a>
                <a className='flex align-center gap-2 items-center text-xl hover:underline text-slate-100' href='mailto:mowtopflight@gmail.com'><MdEmail className='text-2xl' />mowtopflight@gmail.com</a>
            </div>
